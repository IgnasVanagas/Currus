    ...
    highlights: [
        {
            ...
            description: "Architektai, inžinieriai ir gamyba dirba po vienu stogu – tai reiškia mažiau rizikos ir daugiau kontrolės."
        },
        {
            title: "Medžiagų biblioteka",
            description: "Turime daugiau nei 380 akredituotų medžiagų ir apdailų, todėl pasiūlome tinkamiausią kombinaciją jūsų biudžetui."
        },
        {
            title: "Montavimas visoje Europoje",
            description: "Mobilios montavimo komandos leidžia įgyvendinti projektus tiek Lietuvoje, tiek kituose ES miestuose."
        }
    ],
    services: [
        {
            title: "Strateginis projektavimas",
            description: "Analizuojame verslo tikslus ir erdvių scenarijus, kad baldai veiktų kaip jūsų prekės ženklo tęsinys.",
            points: ["Zonavimo ir srautų planavimas", "3D vizualizacijos ir VR sesijos", "Tvarumo auditai"]
        },
        {
            title: "Gamyba ir surinkimas",
            description: "Gaminame baldus savo dirbtuvėse, užtikriname kokybės patikrą ir montuojame pagal grafiką.",
            points: ["CNC apdirbimas ir lakavimas", "Metalo ir stiklo integracijos", "Transportas ir montavimas"]
        },
        {
            title: "Garantinė priežiūra",
            description: "Užtikriname baldų priežiūrą ir atnaujinimus, kad erdvės išliktų aktualios ir funkcionalios.",
    ...
    projects: [
        {
            ...
            description: "Sujungėme bendradarbystės zonas su koncentruoto darbo kambariais, akustinėmis kapsulėmis ir moduline konferencijų infrastruktūra.",
        ...
        },
        {
            ...
            description: "Prabangus, bet jaukus vestibiulis su specialiai gaminta recepcija, natūraliomis tekstilėmis ir apšvietimo scenarijais.",
        ...
        },
        {
            ...
            description: "Adaptavome erdves intensyviems susitikimams ir hibridiniam darbui su modulinių baldų sistema.",
    ...
    process: [
        {
            ...
            description: "Išsigryniname verslo tikslus, srautų diagramas ir estetinius kriterijus, kad visi sprendimai būtų pamatuoti.",
            icon: "insights"
        },
        {
            title: "Dizaino ir prototipų studija",
            description: "Parengiame 3D vizualizacijas, medžiagų pavyzdžius ir prototipus – galite pajausti rezultatą dar prieš gamybą.",
            icon: "design"
        },
        {
            title: "Gamyba ir logistika",
            description: "Savo dirbtuvėse gaminame baldus, koordinuojame tiekėjus ir planuojame montavimą pagal jūsų grafiką.",
            icon: "build"
        },
        {
            title: "Priežiūra",
            description: "Po įdiegimo siūlome priežiūros planus, modulinius papildymus ir greitą reagavimą į pokyčius.",
            icon: "care"
        }
    ],
    assurance: [
        {
            ...
            description: "Kiekvienam projektui taikome 4 kontrolinius etapus ir pateikiame gamybos ataskaitas."
        },
        {
            title: "Medžiagų tvarumas",
            description: "Dirbame tik su FSC, PEFC ir OEKO-TEX sertifikuotais tiekėjais, pateikiame lydinčius dokumentus."
        },
        {
            title: "Serviso garantijos",
            description: "Siūlome išplėstines garantijas iki 5 metų ir papildomus priežiūros vizitus."
        }
    ],
    contact: {
        id: "kontaktai",
        title: "Pasikalbėkime apie jūsų erdves",
        description: "Susisiekite dėl pirminės konsultacijos ar projekto apimčių įvertinimo – atsakome per vieną darbo dieną.",
        advisor: {
            name: "Rasa Vaitkutė",
    ...
    highlights: [
        {
            ...
            description: "6 ašių CNC centrai ir automatizuotos pjovimo linijos leidžia dirbti su sudėtingais kontūrais ir serijomis."
        },
        {
            title: "Atsekamumas",
            description: "Kiekviena detalė žymima QR kodais, todėl tiekimo grandinė matoma realiu laiku."
        },
        {
            title: "Tarptautinė logistika",
            description: "Reguliarūs reisai į Baltijos ir Skandinavijos šalis užtikrina greitą pristatymą."
        }
    ],
    services: [
        {
            title: "Plokščių apdirbimas",
            description: "Dirbame su MDF, LMDP, faneruote ir plokštėmis su specialiomis savybėmis – nuo atsparumo ugniai iki antibakterinio paviršiaus.",
            points: [
        ...
        },
        {
            ...
            description: "Integruojame metalines konstrukcijas, stiklo intarpus ir furnitūrą, suderiname su jūsų tiekėjais.",
            points: ["Metalo pjovimas ir miltelinis dažymas", "Grūdinto stiklo parinkimas", "Furnitūros surinkimas"]
        },
        {
            title: "Paviršių apdaila",
            description: "Nuo dažymo iki natūralios faneruotės – parenkame apdailą, kuri atitinka projekto techninę specifikaciją.",
    ...
    projects: [
        {
            ...
            description: "Per 4 savaites pagaminome 180 modulių tinklo parduotuvėms, kartu su logistikos planavimu ir montavimo instrukcijomis.",
            image: "https://images.unsplash.com/photo-1505691723518-36a5ac3be353?auto=format&fit=crop&w=1600&q=80",
        ...
        },
        {
            ...
            description: "Pagaminome faneruotas ir milteliniu būdu dažytas detales Vokietijos interjero studijai su 0.1 mm tolerancija.",
            image: "https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=1600&q=80",
        ...
        },
        {
            ...
            description: "Sukūrėme modulinę spintų sistemą su iš anksto sumontuota furnitūra, kad montavimas vietoje užtruktų mažiau nei 20 min.",
            image: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=1600&q=80",
    ...
    process: [
        {
            ...
            description: "Per 24 valandas pateikiame pasiūlymą ir aptariame gamybos langus, alternatyvias medžiagas ar optimizacijas.",
            icon: "insights"
        },
        {
            title: "Techninis paruošimas",
            description: "Kuriame techninius brėžinius, parengiame bandomąją partiją ir suderiname kokybės parametrus.",
            icon: "design"
        },
        {
            title: "Serijinė gamyba",
            description: "Paleidžiame gamybą su automatizuotu planavimu, pateikiame gamybos ataskaitas ir QR žymų sąrašus.",
            icon: "build"
        },
        {
            title: "Logistika ir kokybė",
            description: "Organizuojame transportą, pasirūpiname muitiniais dokumentais ir pateikiame kokybės sertifikatų paketą.",
            icon: "logistics"
        }
    ],
    assurance: [
        ...
        },
        {
            ...
            description: "Dirbame pagal ISO 9001 ir 14001 reikalavimus, todėl užtikriname kokybės ir aplinkosaugos rodiklius."
        },
        {
            title: "Operatyvus servisas",
            description: "Pagal SLA sutartis reaguojame per 12 valandų ir pradedame korekcijas per 48 valandas."
        }
    ],
    contact: {
        id: "kontaktai",
        title: "Kalbėkimės apie detales",
        description: "Sertifikuoti technologai padės suderinti medžiagas, tolerancijas ir logistiką – susisiekite dėl bandomosios partijos.",
        advisor: {
